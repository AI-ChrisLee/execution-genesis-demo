...
It asks who the demo is for. Make a business up, or point it at a real one:
    ...
    /the-demo <the business>, <its website or page link>

It needs `squad/business.md` first. Run `/the-winning-offer` if you do not have it yet.
...
your buyer sees the demo. Next: `/the-close`.
